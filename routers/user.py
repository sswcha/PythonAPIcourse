...
# GET ONE USER
@router.get("/{id}", status_code=status.HTTP_200_OK, response_model=db_schemas.UserReturn)
...
# CREATE ONE USER
@router.post("/", status_code=status.HTTP_201_CREATED, response_model=db_schemas.UserReturn)
...
# UPDATE ONE USER
@router.put("/{id}", status_code=status.HTTP_202_ACCEPTED, response_model=db_schemas.User)
